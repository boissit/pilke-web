...
| --- | --- |
| `/en/` | `treffit` 600px<br>`platter` 600px<br>`invitation` 600px<br>`date` 600px<br>`feedback` 600px<br>`05` 81px<br>`asetukset` 460px |
| `/en/nain-se-toimii/` | `story` 500px<br>`platter` 500px<br>`05` 73px<br>`date` 500px |
| `/en/turvallisuus/` | `asetukset` 520px |
| `/` | `treffit` 600px<br>`platter` 600px<br>`invitation` 600px<br>`date` 600px<br>`feedback` 600px<br>`05` 81px<br>`asetukset` 460px |
| `/nain-se-toimii/` | `story` 500px<br>`platter` 500px<br>`05` 73px<br>`date` 500px |
| `/turvallisuus/` | `asetukset` 520px |

Carried but drawn on no page: `kalenteri`.
...
| `kalenteri` | Calendar | `screenshots.yaml` | The week grid with two bookings on it, the tab bar. Carried but drawn on no page |
